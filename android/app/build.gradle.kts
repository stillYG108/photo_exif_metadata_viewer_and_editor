...
android {
    ...
    defaultConfig {
        applicationId = "com.example.exif"  // Must match google-services.json package_name
    ...
    buildTypes {
        release {
            // Use release signing config if key.properties exists, else fall back to debug
